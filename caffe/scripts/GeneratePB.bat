if exist "../src/caffe/proto/caffe.pb.h" (
    ...
    "../../3rdparty/3rdparty/bin/protoc" -I="../src/caffe/proto" --cpp_out="../src/caffe/proto" "../src/caffe/proto/caffe.proto"
)
...
if exist "../src/caffe/proto/caffe_pretty_print.pb.h" (
    ...
    "../../3rdparty/3rdparty/bin/protoc" -I="../src/caffe/proto" --cpp_out="../src/caffe/proto" "../src/caffe/proto/caffe_pretty_print.proto"
)
